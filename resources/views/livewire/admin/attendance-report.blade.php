<div class="p-4 sm:p-6 max-w-7xl mx-auto space-y-6" x-data="{
    ...
    <div class="print-only mb-6">
        <div class="text-center pb-3 border-b-2 border-black space-y-1 relative">
            ...
            <p class="text-[10pt] italic">Jl. Pendidikan No. 45, Kota Mimpi, Jawa Barat • Telp: (021) 1234567 • Website:
                www.school.id</p>
    ...
    <div
        ...
        <div>
            <h1 class="text-lg sm:text-xl font-bold text-gray-900">Rekapitulasi Absensi (Rentang Bulan)</h1>
                    ...
                    @empty
                        <tr>
                            <td colspan="10" class="p-8 text-center text-gray-400">
                                Belum ada data presensi pada rentang bulan ini.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
                                            ...
                                            <div>
                                                <template x-if="cell.details && cell.details.length > 0">
                                                    <button @click="openModal = true; modalData = cell"
                                                        ...
                                                        <span class="text-xs sm:text-sm font-black font-mono mt-0.5"
